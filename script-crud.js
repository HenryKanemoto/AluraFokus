...
const editarTarefa = (estado, tarefa, novaDescricao) => {
...
const deletarTarefa = (estado, idTarefa) => {
...
const atualizarUI = () => {
    ...
    const paragraphTarefaSelecionada = document.querySelector('.app__section-active-task-description');
    ...
    estadoInicial.tarefas.forEach(tarefa => {
        ...
        button.addEventListener('click', () => {
            ...
            const idTarefa = estadoInicial.tarefas.indexOf(tarefa);
